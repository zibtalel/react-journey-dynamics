...
BEGIN TRY
	...
	WHEN NOT MATCHED
		THEN
			...
			VALUES (NEWID(), source.[OrderId], source.[PosNo], source.[ItemNo], source.[Description], source.[Comment], 0, 'Created', dbo.GetFutureUtcDate(), 'Import', dbo.GetFutureUtcDate(), 'Import', 0, 1, source.[InstallationId])
	WHEN MATCHED 
