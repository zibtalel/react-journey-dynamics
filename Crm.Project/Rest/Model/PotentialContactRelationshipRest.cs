namespace Crm.Project.Rest.Model
{
	...
	[RestTypeFor(DomainType = typeof(PotentialContactRelationship))]
	public class PotentialContactRelationshipRest : RestEntityWithExtensionValues
	{
		public Guid ParentId { get; set; }
		public Guid ChildId { get; set; }
		public string Information { get; set; }
		public string RelationshipTypeKey { get; set; }
		[ExplicitExpand, NotReceived] public PotentialRest Potential { get; set; }
