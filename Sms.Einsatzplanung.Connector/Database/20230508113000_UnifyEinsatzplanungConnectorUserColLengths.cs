namespace Sms.Einsatzplanung.Connector.Database
{
	...
	[Migration(20230508113000)]
	public class UnifyEinsatzplanungConnectorUserColLengths : Migration
	{
		public override void Up()
		{
			(string, string)[] tables = { ("RPL", "Dispatch"), ("RPL", "Profile"), ("SMS", "Scheduler"), ("SMS", "SchedulerClickOnceVersion"), ("SMS", "SchedulerConfig"), ("SMS", "SchedulerIcon") };
