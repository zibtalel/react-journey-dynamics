namespace Sms.Einsatzplanung.Connector.EventHandlers
{
	using System;
	...
	public class RplTaskUpdater : IEventHandler<EntityCreatedEvent<ServiceOrderDispatch>>, IEventHandler<EntityModifiedEvent<ServiceOrderDispatch>>, IEventHandler<EntityDeletedEvent<ServiceOrderDispatch>>
	{
		...
		protected virtual DateTime GetStartTime(RplDispatch rplServiceOrderDispatch, ServiceOrderDispatch dispatch)
		{
			...
			var startTime = TimeZoneInfo.ConvertTimeFromUtc(dispatch.Time, timezone);
			return startTime;
		}
		protected virtual void SetDispatchRplTaskProperties(RplDispatch rplServiceOrderDispatch, ServiceOrderDispatch dispatch)
		{
			...
			if (dispatch.Status.IsRejected())
			{
				...
				rplServiceOrderDispatch.IsActive = false;
