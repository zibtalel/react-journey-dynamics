namespace Crm.DynamicForms.Database
{
	...
	[Migration(20230508105500)]
	public class UnifyDynamicFormUserColLengths : Migration
	{
		public override void Up()
		{
			(string, string)[] tables = { ("CRM", "DynamicForm"), ("CRM", "DynamicFormElement"), ("CRM", "DynamicFormReference"), ("LU", "DynamicFormCategory") };
