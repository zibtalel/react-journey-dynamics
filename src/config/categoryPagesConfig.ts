...
export const categoryPagesConfig: Record<string, CategoryPageConfig> = {
  ...
  "vetements-travail/vestes": {
    title: "Vestes de Travail",
    description: "Vestes professionnelles robustes et fonctionnelles pour tous les métiers",
    bannerImage: "/lovable-uploads/98a68746-eff6-4ad1-b7d9-7fed922db14f.png",
    features: [
      {
        title: "Durabilité",
        description: "Matériaux résistants pour une utilisation quotidienne intensive"
      },
      {
        title: "Fonctionnalité",
        description: "Multiples poches et rangements pratiques pour vos outils"
      },
      {
        title: "Confort",
        description: "Conçues pour offrir une liberté de mouvement optimale"
      }
    ],
    categoryType: "vetements-travail",
    parentCategory: "Vêtements de Travail"
  ...
  // Standardized features for all Produits Marketing subcategories
  ...
  "nos-packs/restaurant": {
    title: "Pack Restaurant",
    description: "Packs personnalisés pour équiper votre restaurant",
    bannerImage: "/Subitems/Banners/PackRestaurantBanner.png",
    features: [
      {
        title: "Personnalisation",
        description: "Créez un pack unique pour votre restaurant"
      },
      {
        title: "Qualité",
        description: "Des produits de qualité pour votre établissement"
      },
      {
        title: "Visibilité",
        description: "Mettez en avant votre identité visuelle"
      }
    ],
    categoryType: "nos-packs",
    parentCategory: "Nos Packs"
  },
  "nos-packs/hotel": {
    title: "Pack Hôtel",
    description: "Packs personnalisés pour équiper votre hôtel",
    bannerImage: "/Subitems/Banners/PackHotelBanner.png",
    features: [
      {
        title: "Personnalisation",
        description: "Créez un pack unique pour votre hôtel"
      },
      {
        title: "Qualité",
        description: "Des produits de qualité pour votre établissement"
  ...
  "nos-packs/caffe": {
    title: "Pack Café",
    description: "Packs personnalisés pour équiper votre café",
    bannerImage: "/Subitems/Banners/PackCaffeBanner.png",
    features: [
      {
        title: "Personnalisation",
        description: "Créez un pack unique pour votre café"
      },
      {
        title: "Qualité",
        description: "Des produits de qualité pour votre établissement"
  ...
  "nos-packs/medecin": {
    title: "Pack Médécin",
    description: "Packs personnalisés pour équiper votre cabinet médical",
    bannerImage: "/Subitems/Banners/PackMedecinBanner.png",
    features: [
      {
        title: "Personnalisation",
        description: "Créez un pack unique pour votre cabinet médical"
      },
      {
        title: "Qualité",
        description: "Des produits de qualité pour votre établissement"
