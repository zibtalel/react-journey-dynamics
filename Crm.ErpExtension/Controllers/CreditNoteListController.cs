namespace Crm.ErpExtension.Controllers
{
	...
	public class CreditNoteListController : GenericListController<CreditNote>
	{
		public CreditNoteListController(IPluginProvider pluginProvider, IEnumerable<IRssFeedProvider<CreditNote>> rssFeedProviders, IEnumerable<ICsvDefinition<CreditNote>> csvDefinitions, IEntityConfigurationProvider<CreditNote> entityConfigurationProvider, IRepository<CreditNote> repository, IAppSettingsProvider appSettingsProvider, IResourceManager resourceManager, RestTypeProvider restTypeProvider)
