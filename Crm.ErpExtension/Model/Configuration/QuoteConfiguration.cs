namespace Crm.ErpExtension.Model.Configuration
{
	...
	public class QuoteConfiguration : EntityConfiguration<Quote>
	{
		public override void Initialize()
		{
			...
			Property(x => x.QuoteNo, c => c.Filterable(f => f.Caption("T_QuoteNo")));

			Property(x => x.QuoteDate, c =>
			{
		...
		public QuoteConfiguration(IEntityConfigurationHolder<Quote> entityConfigurationHolder)
