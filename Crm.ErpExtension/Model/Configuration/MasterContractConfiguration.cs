namespace Crm.ErpExtension.Model.Configuration
{
	...
	public class MasterContractConfiguration : EntityConfiguration<MasterContract>
	{
		...
		public MasterContractConfiguration(IEntityConfigurationHolder<MasterContract> entityConfigurationHolder)
