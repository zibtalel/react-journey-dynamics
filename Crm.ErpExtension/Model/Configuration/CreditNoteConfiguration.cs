namespace Crm.ErpExtension.Model.Configuration
{
	...
	public class CreditNoteConfiguration : EntityConfiguration<CreditNote>
	{
		public override void Initialize()
		{
			...
			Property(x => x.CreditNoteNo, c => c.Filterable(f => f.Caption("T_CreditNoteNo")));

			Property(x => x.CreditNoteDate, c =>
			{
		...
		public CreditNoteConfiguration(IEntityConfigurationHolder<CreditNote> entityConfigurationHolder)
