namespace Crm.ErpExtension.Model.Configuration
{
	...
	public class InvoiceConfiguration : EntityConfiguration<Invoice>
	{
		public override void Initialize()
		{
			...
			Property(x => x.InvoiceNo, c => c.Filterable(f => f.Caption("T_InvoiceNo")));

			Property(x => x.InvoiceDate, c =>
			{
		...
		public InvoiceConfiguration(IEntityConfigurationHolder<Invoice> entityConfigurationHolder)
