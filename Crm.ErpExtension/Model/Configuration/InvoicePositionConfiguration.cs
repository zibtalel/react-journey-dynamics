namespace Crm.ErpExtension.Model.Configuration
{
	...
	public class InvoicePositionConfiguration : EntityConfiguration<InvoicePosition>
	{
		public override void Initialize()
		{
			NestedProperty(x => x.Parent.InvoiceDate, c =>
			{
			...
			NestedProperty(x => x.Parent.InvoiceNo, c =>
			{
				c.Filterable(f => f.Caption("T_InvoiceNo"));
				c.Sortable(s => s.SortCaption("T_InvoiceNo"));
			});
		...
		public InvoicePositionConfiguration(IEntityConfigurationHolder<InvoicePosition> entityConfigurationHolder)
