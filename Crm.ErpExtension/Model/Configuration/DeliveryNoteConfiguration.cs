namespace Crm.ErpExtension.Model.Configuration
{
	...
	public class DeliveryNoteConfiguration : EntityConfiguration<DeliveryNote>
	{
		public override void Initialize()
		{
			...
			Property(x => x.DeliveryNoteNo, c => c.Filterable(f => f.Caption("T_DeliveryNoteNo")));

			Property(x => x.DeliveryNoteDate, c =>
			{
		...
		public DeliveryNoteConfiguration(IEntityConfigurationHolder<DeliveryNote> entityConfigurationHolder)
