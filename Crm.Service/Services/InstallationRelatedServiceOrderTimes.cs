namespace Crm.Service.Services
{
	...
	public class InstallationRelatedServiceOrderTimes : IRelatedContact<Installation>
	{
		private readonly IRepositoryWithTypedId<ServiceOrderTime, Guid> serviceOrderTimeRepository;
		public InstallationRelatedServiceOrderTimes(IRepositoryWithTypedId<ServiceOrderTime, Guid> serviceOrderTimeRepository)
		{
